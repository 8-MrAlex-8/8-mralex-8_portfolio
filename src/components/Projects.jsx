...
const projects = [
  ...
  },
  {
    ...
    impact:
      "[DEV] Delivered an enterprise-grade SSL and license tracking system for 50+ applications, implementing audit logging, LDAP auth, and centralized expiration management. \n[AUTOMATION] Processed 500+ schedules in <5s. Closed 30% of team backlog.",
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          <h2 className="text-4xl md:text-6xl font-bold text-white tracking-tight leading-none">
            Project
            <br />
            <span className="text-purple-500">Highlights_</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-6 auto-rows-auto">
          {projects.map((project, index) => (
            <motion.div
              ...
              className={`
                 group relative rounded-2xl border border-white/5 bg-slate-900 
            ...
            >
              {/* Background Tint */}
              <div
                className={`absolute inset-0 ${project.color} opacity-40 group-hover:opacity-60 transition-opacity rounded-2xl`}
              />
              ...
              <div className="relative z-10 flex-1 p-6 flex flex-col justify-between min-h-[300px]">
                  ...
                  <div className="flex flex-col gap-4">
                    <div>
                      ...
                      <div className="group/impact relative inline-block mt-2 cursor-help">
                        ...
                        <div className="absolute left-0 bottom-full mb-3 w-72 md:w-96 bg-slate-950/95 backdrop-blur-xl border border-purple-500/30 p-4 rounded-xl shadow-2xl opacity-0 group-hover/impact:opacity-100 group-hover/impact:pointer-events-auto pointer-events-none transition-all duration-200 z-[100] translate-y-2 group-hover/impact:translate-y-0 text-left">
                ...
                <div className="mt-auto">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    ...
                    {/* Placeholder Gallery */}
                    {!Object.values(project.links || {}).some((val) => val) &&
                      !project.nda && (
