...
const Hero = () => {
  ...
  return (
    <section
      id="hero"
      className="min-h-screen flex items-center justify-center p-0 relative overflow-hidden bg-slate-950"
    >
      ...
      <div className="w-full h-full max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 min-h-screen items-center relative z-20">
        ...
        <div className="md:col-span-7 flex flex-col justify-center px-6 sm:px-12 pt-20 md:pt-0">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-slate-300 font-light max-w-lg leading-relaxed mb-8">
              Engineering production-ready systems that streamline operations,
              deliver real-world impact, and scale with business needs.
            </p>
        ...
        <div className="md:col-span-5 h-[300px] md:h-[600px] w-full relative flex items-center justify-center">
          <div className="relative w-64 h-64 md:w-96 md:h-96 mx-auto rounded-full overflow-hidden border-4 border-white/40">
          ...
          {/* Decorative Elements */}
          <div
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] border border-dashed border-white/30 rounded-full animate-spin-slow"
